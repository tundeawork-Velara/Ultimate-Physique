...
const meals = {
  [T]: [
    { id:"m1",time:"9:00 AM",label:"MEAL 1",title:"Post-Workout Recovery Breakfast",sub:"Break the fast · Anabolic window · Largest meal",emoji:"🍳",color:"#C8943A",
      ...
      note:"Break the fast within 30 min of ending training. Whey + eggs create a rapid leucine spike. Banana replenishes glycogen. D3/K2 drops taken here — fat from eggs + olive oil aids absorption.",
