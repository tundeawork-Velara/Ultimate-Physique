...
// ─── SKIN ───────────────────────────────────────────────────────
const skinDays = [
  { day:"Mon",tag:"EXFOLIATION",emoji:"🔬",color:"#3A8F5C",type:"AM Brighten + Exfoliation PM",focus:["SA Cleanse","Vit C Stack","Glycolic PM"],
    ...
    pm:[{num:"1",product:"CeraVe Acne Control Cleanser (2% Salicylic Acid)",instruction:"Cleanse. Rinse. Pat dry.",note:"PM cleanse fine daily — SA at 2% is gentle enough for twice daily."},{num:"2",product:"Glycolic Acid 7% Toner",instruction:"Cotton pad, full face. Avoid eye area. Wait 10 min.",note:"SA cleanser AM + Glycolic PM = full exfoliation cycle. Never use both same step."},{num:"3",product:"Niacinamide 10% + Zinc 1%",instruction:"Full face after acid absorbs.",note:null},{num:"4",product:"Hyaluronic Acid Serum",instruction:"Layer over Niacinamide.",note:null},{num:"5",product:"Cetaphil Moisturizer",instruction:"Seal.",note:null},{num:"6",product:"Vitamin E Oil",instruction:"2–3 drops — final step.",note:"Restores lipid barrier after acid exfoliation."}] },
  ...
  { day:"Wed",tag:"EXFOLIATION",emoji:"🔬",color:"#3A8F5C",type:"AM Brighten + Exfoliation PM",focus:["SA Cleanse","Vit C Stack","Glycolic PM"],
  ...
  { day:"Fri",tag:"EXFOLIATION",emoji:"🔬",color:"#3A8F5C",type:"AM Brighten + Exfoliation PM",focus:["SA Cleanse","Vit C Stack","Glycolic PM"],
    am:[{num:"1",product:"CeraVe Acne Control Cleanser (2% Salicylic Acid)",instruction:"Lather 60 sec. Rinse.",note:null},{num:"2",product:"Vitamin C Serum",instruction:"3–4 drops. Wait 3 min.",note:null},{num:"3",product:"Hyaluronic Acid Serum",instruction:"On damp skin.",note:null},{num:"4",product:"Alpha Arbutin 2% + HA",instruction:"Focus dark spots.",note:null},{num:"5",product:"Cetaphil Moisturizer",instruction:"Seal.",note:null},{num:"6",product:"Neutrogena Ultra Sheer SPF 70",instruction:"Final step.",note:null}],
...
const skinRules = [
  ...
  {icon:"✅",color:"#27AE60",text:"SPF 70 every morning. SA + Vit C + Retinol + Glycolic all increase photosensitivity."},
  {icon:"💡",color:"#C9A84C",text:"SA cleanser AM + Glycolic PM = full BHA/AHA cycle for Mon/Wed/Fri. Do not stack both same step."},
  {icon:"💡",color:"#C9A84C",text:"Allow 10–15 min dry time after SA cleanse before Retinol — reduces irritation."},
        ...
        {tab==="skin" && (
          <div>
            ...
            <div style={{ padding:"9px 13px", background:"#1E0808", border:"1px solid #C0392B30", borderRadius:8, marginBottom:14, fontSize:11, color:"#7A3030", lineHeight:1.7 }}>
              ...
              Vit C + Niacinamide never together · Retinol + Glycolic never same night · Aztec mask = no other actives
            </div>
            <div style={{ display:"flex", gap:6, marginBottom:18, flexWrap:"wrap" }}>
              {skinDays.map((d,i)=>(
